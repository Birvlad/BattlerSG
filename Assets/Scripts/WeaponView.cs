...
public class WeaponView : MonoBehaviour
{
    ...
    void Start()
    {
        if (skillCostText == null) Debug.LogError("WeaponView(" + gameObject.name + "):skillCostText == null");
        if (barImage == null) Debug.LogError("WeaponView(" + gameObject.name + "):barImage == null");
        if (mainBarImage == null) Debug.LogError("WeaponView(" + gameObject.name + "):mainBarImage == null");
        if (skillImage == null) Debug.LogError("WeaponView(" + gameObject.name + "):skillImage == null");
